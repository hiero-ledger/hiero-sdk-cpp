...
#ifndef HIERO_TCK_CPP_CLAIM_AIRDROP_PARAMS_H_
#define HIERO_TCK_CPP_CLAIM_AIRDROP_PARAMS_H_
...
{
/**
 * Struct to hold the arguments for a `claimAirdrop` JSON-RPC method call.
 */
...
{
/**
 * JSON serializer template specialization required to convert ClaimAirdropParams arguments properly.
 */
template<>
struct [[maybe_unused]] adl_serializer<Hiero::TCK::TokenService::ClaimAirdropParams>
{
  /**
   * Convert a JSON object to a ClaimAirdropParams.
   *
   * @param jsonFrom The JSON object with which to fill the ClaimAirdropParams.
   * @param params   The ClaimAirdropParams to fill with the JSON object.
   */
  static void from_json(const json& jsonFrom, Hiero::TCK::TokenService::ClaimAirdropParams& params)
  {
...
#endif // HIERO_TCK_CPP_CLAIM_AIRDROP_PARAMS_H_