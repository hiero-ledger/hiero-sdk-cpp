...
int main(int argc, char** argv)
{
   ...
   */
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> firstAccountPrivateKey =
  ...
  const AccountId firstAccountId = AccountCreateTransaction()
                                     ...
                                     .setKeyWithoutAlias(firstAccountPrivateKey)
                                     .freezeWith(&client)
  ...
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> secondAccountPrivateKey =
    ECDSAsecp256k1PrivateKey::generatePrivateKey();
  const AccountId secondAccountId = AccountCreateTransaction()
                                      .setInitialBalance(Hbar(10LL))
                                      .setKeyWithoutAlias(secondAccountPrivateKey)
                                      .freezeWith(&client)
  ...
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> thirdAccountPrivateKey =
    ECDSAsecp256k1PrivateKey::generatePrivateKey();
  const AccountId thirdAccountId = AccountCreateTransaction()
                                     .setInitialBalance(Hbar(10LL))
                                     .setKeyWithoutAlias(thirdAccountPrivateKey)
                                     .freezeWith(&client)
