...
int main(int argc, char** argv)
{
  ...
  const std::shared_ptr<PrivateKey> exchangeKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();

  // Generate a key for a user.
  const std::shared_ptr<PrivateKey> userKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
