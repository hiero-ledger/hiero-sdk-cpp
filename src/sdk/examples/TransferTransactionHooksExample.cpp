...
Prerequisites setupPrerequisites(Client& client, const std::shared_ptr<PrivateKey>& operatorKey)
{
  ...
  return { hookContractId, senderAccountId, senderPrivateKey, receiverAccountId, fungibleTokenId, nftId };
}
...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    const auto [hookContractId, senderAccountId, senderPrivateKey, receiverAccountId, fungibleTokenId, nftId] =
      setupPrerequisites(client, operatorPrivateKey);
