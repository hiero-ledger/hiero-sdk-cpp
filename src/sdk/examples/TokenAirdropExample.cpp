...
int main(int argc, char** argv)
{
  ...
  std::shared_ptr<PrivateKey> aliceKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  ...
  std::shared_ptr<PrivateKey> bobKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  ...
  std::shared_ptr<PrivateKey> carolKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  ...
  std::shared_ptr<PrivateKey> treasuryKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
