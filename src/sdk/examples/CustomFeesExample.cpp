...
int main(int argc, char** argv)
{
  ...
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> aliceKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  ...
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> bobKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  ...
  const std::shared_ptr<ECDSAsecp256k1PrivateKey> charlieKey = ECDSAsecp256k1PrivateKey::generatePrivateKey();
