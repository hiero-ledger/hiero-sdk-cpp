...
int main(int argc, char** argv)
{
  ...
  const std::shared_ptr<PrivateKey> key1 = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  std::cout << "Generated key: " << key1->toStringRaw() << std::endl;

  const std::shared_ptr<PrivateKey> key2 = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  std::cout << "Generated key: " << key2->toStringRaw() << std::endl;

  const std::shared_ptr<PrivateKey> key3 = ECDSAsecp256k1PrivateKey::generatePrivateKey();
