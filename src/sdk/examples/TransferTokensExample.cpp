...
int main(int argc, char** argv)
{
  ...
  const std::shared_ptr<PrivateKey> privateKey1 = ECDSAsecp256k1PrivateKey::generatePrivateKey();
  const std::shared_ptr<PrivateKey> privateKey2 = ECDSAsecp256k1PrivateKey::generatePrivateKey();
